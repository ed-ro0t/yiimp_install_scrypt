...
sudo service php7.0-fpm reload
    ...
    # create database
    Q1="CREATE DATABASE IF NOT EXISTS yiimpnext;"
...
' | sudo -E tee /etc/yiimp/keys.php >/dev/null 2>&1
    ...
    output "Database 'yiimpnext' and users 'panel' and 'stratum' created with password $password and $password2, will be saved for you"
    output ""
...
sudo sed -i 's/database = yaamp/database = yiimpnext/g' *.conf
